  ...
  <section id="about" className="flex min-h-screen items-center bg-white px-6 py-24">
    <div className="mx-auto max-w-3xl text-ink">
      ...
      <div className="space-y-5 text-base leading-relaxed text-stone-700">
        ...
        />
        <p>
          Data Science master's, with a Philosophy degree before it. The mix surprised people more than it
          surprised me: Philosophy taught me to question how a problem is framed before reaching for a tool,
          and Data Science gave me the tools to actually ship the answer. I've always cared more about the
          problem than about the tech stack, which is probably why I ended up at the intersection of language,
          data, and systems, and why most of what I find interesting starts from a question rather than from
          a framework.
        </p>
        <p>
