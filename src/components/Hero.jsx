...
const scrollOneViewport = () => window.scrollTo({ top: window.innerHeight, behavior: 'smooth' });
...
ì    <div className="absolute inset-0 z-0 bg-bg-hero-fallback" />
    ...
    <picture>
      <source
        ...
        srcSet={`${import.meta.env.BASE_URL}assets/images/upscaled_background_mobile.jpg`}
      />
      <img
    ...
    <div className="relative z-[3] flex h-full flex-col items-center justify-center gap-10 px-8 md:flex-row md:justify-between md:px-24 lg:px-36">
      <div className="flex flex-col items-center text-center md:items-start md:text-left font-display">
        ...
        <div
          aria-label="Roles: Data Scientist, ML Engineer, AI Engineer, Full Stack"
          className="mt-3 w-full flex-col items-center flex h-6 items-center justify-center"
        >
          <TypeAnimation
            sequence={[
              'AI Systems Engineer',
