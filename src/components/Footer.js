            ...
            <div className='container'>
                <div className='row'>
                    ...
                    <List type="inline">
                        ...
                        <ListInlineItem>
                            <a href='https://www.linkedin.com/in/gabriele-ghisleni-bb553a199/'><i className="fa fa-linkedin fa-lg"></i></a>
                        </ListInlineItem>
                        <ListInlineItem>
                            <a href='https://www.facebook.com/gabriele.ghisleni.125'><i className="fa fa-facebook fa-lg"></i></a>
                        </ListInlineItem>
                        <ListInlineItem>
